...
export default function AdvertCarousel({ isReverse, scrollSpeed }: AdvertCarouselProps) {
    ...
    <div className=" main__container">
      <section className="enable-animation">
        <div className={`marquee ${isReverse && "marquee--reverse"}`}>
              ...
              >
                {businessDetails.map((business, index) => (
                  <div key={index} className=" marquee__item">
                    <div className="marquee__item--content" style={{ backgroundImage: `url(${business.image.url})` }}>
                      <AnimatePresence>
                        <motion.div
                        ...
                        >
                          <h3 className="marquee__item--content--heading--details ">{business.name}</h3>
                        </motion.div>
                      </AnimatePresence>
          ...
          {showModal && <Modal cards={selectedCard} onClose={() => setShowModal(false)} />}
        </div>
      </section>
    </div>
  )
